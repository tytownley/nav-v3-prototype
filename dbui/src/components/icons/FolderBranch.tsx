...
/** use:object Git folder | Workspace | git folder, versioned directory */
const FolderBranch = forwardRef<SVGSVGElement, React.SVGProps<SVGSVGElement> & { size?: number }>(
...
FolderBranch.displayName = "FolderBranch"
export { FolderBranch }

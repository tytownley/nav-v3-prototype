...
/** use:action Marker | flag, milestone, waypoint */
const FlagPointer = forwardRef<SVGSVGElement, React.SVGProps<SVGSVGElement> & { size?: number }>(
...
FlagPointer.displayName = "FlagPointer"
export { FlagPointer }

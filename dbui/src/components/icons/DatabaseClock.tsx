...
/** use:object Temporal Table | Unity Catalog | time travel, versioned data */
const DatabaseClock = forwardRef<SVGSVGElement, React.SVGProps<SVGSVGElement> & { size?: number }>(
...
DatabaseClock.displayName = "DatabaseClock"
export { DatabaseClock }

...
/** use:object SQL Warehouse | Compute | remote processing, hosted compute */
const CloudDatabase = forwardRef<SVGSVGElement, React.SVGProps<SVGSVGElement> & { size?: number }>(
...
CloudDatabase.displayName = "CloudDatabase"

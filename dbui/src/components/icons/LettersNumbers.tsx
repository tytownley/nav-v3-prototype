...
/** use:object Alphanumeric | Data Type | mixed type, text+numbers */
const LettersNumbers = forwardRef<SVGSVGElement, React.SVGProps<SVGSVGElement> & { size?: number }>(
...
LettersNumbers.displayName = "LettersNumbers"
export { LettersNumbers }

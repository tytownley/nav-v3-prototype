...
/** use:object Cloud Credentials | Unity Catalog | cloud access key, provider key */
const CloudKey = forwardRef<SVGSVGElement, React.SVGProps<SVGSVGElement> & { size?: number }>(

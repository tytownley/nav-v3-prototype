...
/** use:action sort A-Z | alphabetical, ascending text */
const AzHorizontal = forwardRef<SVGSVGElement, React.SVGProps<SVGSVGElement> & { size?: number }>(
...
AzHorizontal.displayName = "AzHorizontal"
export { AzHorizontal }

...
/** use:action Joined table | merge, union, combine datasets */
const TableCombine = forwardRef<SVGSVGElement, React.SVGProps<SVGSVGElement> & { size?: number }>(
...
TableCombine.displayName = "TableCombine"
export { TableCombine }

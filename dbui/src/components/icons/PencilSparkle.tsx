...
/** use:action AI edit | smart edit, AI-assisted writing */
const PencilSparkle = forwardRef<SVGSVGElement, React.SVGProps<SVGSVGElement> & { size?: number }>(

...
/** use:object Code workflow | Lakeflow | programmatic job */
const WorkflowCode = forwardRef<SVGSVGElement, React.SVGProps<SVGSVGElement> & { size?: number }>(
...
WorkflowCode.displayName = "WorkflowCode"
export { WorkflowCode }

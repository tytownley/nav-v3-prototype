...
/** use:action AI fix | smart repair, AI tools, auto-fix */
const WrenchSparkle = forwardRef<SVGSVGElement, React.SVGProps<SVGSVGElement> & { size?: number }>(
...
WrenchSparkle.displayName = "WrenchSparkle"
export { WrenchSparkle }

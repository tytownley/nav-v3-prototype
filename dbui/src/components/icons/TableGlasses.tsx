...
/** use:object Table Views | Unity Catalog | views, dataset */
const TableGlasses = forwardRef<SVGSVGElement, React.SVGProps<SVGSVGElement> & { size?: number }>(
...
TableGlasses.displayName = "TableGlasses"
export { TableGlasses }

...
/** use:object Delta Shared Catalog | Unity Catalog | shared, collaborative, Delta Sharing */
const CatalogShared = forwardRef<SVGSVGElement, React.SVGProps<SVGSVGElement> & { size?: number }>(
...
CatalogShared.displayName = "CatalogShared"
export { CatalogShared }

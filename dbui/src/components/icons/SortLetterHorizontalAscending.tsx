...
/** use:action sort A-Z | alphabetical ascending */
const SortLetterHorizontalAscending = forwardRef<SVGSVGElement, React.SVGProps<SVGSVGElement> & { size?: number }>(
...
SortLetterHorizontalAscending.displayName = "SortLetterHorizontalAscending"
export { SortLetterHorizontalAscending }

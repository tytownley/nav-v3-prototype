...
/** use:action import data | data load, ingest to database */
const DatabaseImport = forwardRef<SVGSVGElement, React.SVGProps<SVGSVGElement> & { size?: number }>(
...
DatabaseImport.displayName = "DatabaseImport"
export { DatabaseImport }

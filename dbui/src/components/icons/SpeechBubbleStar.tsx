...
/** use:indicator Featured comment | highlighted feedback, top comment */
const SpeechBubbleStar = forwardRef<SVGSVGElement, React.SVGProps<SVGSVGElement> & { size?: number }>(
...
SpeechBubbleStar.displayName = "SpeechBubbleStar"
export { SpeechBubbleStar }

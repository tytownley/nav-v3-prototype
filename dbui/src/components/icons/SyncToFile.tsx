...
/** use:action sync to file | export, save externally, file transfer */
const SyncToFile = forwardRef<SVGSVGElement, React.SVGProps<SVGSVGElement> & { size?: number }>(
...
SyncToFile.displayName = "SyncToFile"
export { SyncToFile }

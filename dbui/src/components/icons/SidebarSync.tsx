...
/** use:action sync sidebar | refresh navigation */
const SidebarSync = forwardRef<SVGSVGElement, React.SVGProps<SVGSVGElement> & { size?: number }>(
...
SidebarSync.displayName = "SidebarSync"
export { SidebarSync }

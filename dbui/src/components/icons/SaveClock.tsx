...
/** use:indicator auto-saved | save history, version, last saved */
const SaveClock = forwardRef<SVGSVGElement, React.SVGProps<SVGSVGElement> & { size?: number }>(
...
SaveClock.displayName = "SaveClock"
export { SaveClock }

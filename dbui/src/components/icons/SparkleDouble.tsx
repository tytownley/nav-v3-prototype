...
/** use:indicator agentic | genie, generate, assistant */
const SparkleDouble = forwardRef<SVGSVGElement, React.SVGProps<SVGSVGElement> & { size?: number }>(
...
SparkleDouble.displayName = "SparkleDouble"
export { SparkleDouble }

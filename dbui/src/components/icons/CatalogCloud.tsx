...
/** use:object Remote Catalog | Unity Catalog | remote catalog, foreign catalog */
const CatalogCloud = forwardRef<SVGSVGElement, React.SVGProps<SVGSVGElement> & { size?: number }>(
...
CatalogCloud.displayName = "CatalogCloud"
export { CatalogCloud }

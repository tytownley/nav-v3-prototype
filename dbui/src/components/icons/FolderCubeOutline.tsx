...
/** use:object Bundle Folder | Workspace | container */
const FolderCubeOutline = forwardRef<SVGSVGElement, React.SVGProps<SVGSVGElement> & { size?: number }>(
...
FolderCubeOutline.displayName = "FolderCubeOutline"
export { FolderCubeOutline }

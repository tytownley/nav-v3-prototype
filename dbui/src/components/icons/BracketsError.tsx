...
/** use:indicator code error | syntax fail, code invalid */
const BracketsError = forwardRef<SVGSVGElement, React.SVGProps<SVGSVGElement> & { size?: number }>(
...
BracketsError.displayName = "BracketsError"
export { BracketsError }
